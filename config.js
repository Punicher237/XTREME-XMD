...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "XTREME~XMD~jlQTxSTJ#KPaQV_EJpJUleNuyH1i62jCqr8nuJZuUph0gTyTF5gc",
// add your Session Id 
...
BOT_NAME: process.env.BOT_NAME || "þЦЛɪㄈнƐ尺 𝐗𝐌𝐃",
// add bot namw here for menu
STICKER_NAME: process.env.STICKER_NAME || "PUNICHER237",
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "237695429381",
// add your bot owner number
OWNER_NAME: process.env.OWNER_NAME || "PUNICHER",
// add bot owner name
...
DEV: process.env.DEV || "237695429381",
